...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var import_toastify_js, bgList, infoColor, messagesControl;
  ...
  function interceptXHRForCsrf(csrfToken) {
    ...
    window.XMLHttpRequest = function() {
      ...
      xhr.send = function(data2) {
        if (this._isUploadRequest && data2 instanceof FormData) {
          data2.append("csrfmiddlewaretoken", csrfToken);
        }
  ...
  var init_tinymceCsrf = __esm({
    "src/scripts/tinymceCsrf.js"() {
    }
  });

  // src/scripts/productFormset.js
  var productFormset;
  var init_productFormset = __esm({
    "src/scripts/productFormset.js"() {
      productFormset = () => {
        return {
  ...
  // src/scripts/backToTopBtn.js
  var backToTopBtnControl;
  var init_backToTopBtn = __esm({
    "src/scripts/backToTopBtn.js"() {
      backToTopBtnControl = () => {
        return {
          showBackToTop: false,
  ...
  // src/scripts/address.js
  var taiwanDistrictsCache, loadTaiwanDistrictsCache, addressFormControl;
  var init_address = __esm({
    "src/scripts/address.js"() {
      taiwanDistrictsCache = null;
      loadTaiwanDistrictsCache = async () => {
        ...
        return {
          ...
          async init() {
            try {
              ...
              if (this.$refs.county && this.$refs.county.options && this.$refs.county.options.length > 0) {
                this.$refs.county.options[0].disabled = true;
              }
              if (this.$refs.district && this.$refs.district.options && this.$refs.district.options.length > 0) {
                this.$refs.district.options[0].disabled = true;
              }
            } catch (error2) {
              console.error("\u521D\u59CB\u5316\u5730\u5740\u6B04\u4F4D\u5931\u6557", error2);
            }
          },
          ...
          applyDistrict() {
            ...
            if (county) {
              this.$refs.district.innerHTML = '<option value="" disabled>\u8ACB\u9078\u64C7\u5340\u57DF</option>';
          ...
          updateZip() {
            ...
            if (county && district && this.valid[county] && this.valid[county][district]) {
              this.$refs.zip.value = this.valid[county][district];
            } else {
              this.$refs.zip.value = "";
            }
  ...
  // src/scripts/subTabControl.js
  var subTabControl;
  var init_subTabControl = __esm({
    "src/scripts/subTabControl.js"() {
      subTabControl = () => {
        return {
          scrollSubTab() {
            if (window.innerWidth < 769 && this.$refs.activeTab) {
              ...
              let scrollLeft = tab.offsetLeft - parent.offsetLeft + tabRect.width / 2 - parentRect.width / 2;
  ...
  var require_app = __commonJS({
    "src/scripts/app.js"() {
      ...
      module_default.data("messagesControl", messagesControl);
      module_default.data("validators", validators);
      module_default.data("imagePreview", imagePreview);
      module_default.data("productFormset", productFormset);
      module_default.data("backToTopBtnControl", backToTopBtnControl);
      module_default.data("addressFormControl", addressFormControl);
      module_default.data("subTabControl", subTabControl);
